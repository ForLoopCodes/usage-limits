...
const AGENT_KEYS: AgentKey[] = ["github-copilot", "codex", "claude", "zai", "minimax", "vercel-ai"];
...
function applyEnvironmentOverrides(config: AppConfig): AppConfig {
  ...
  next.agents["github-copilot"].username ??= trimOrUndefined(Bun.env.GITHUB_USERNAME);
